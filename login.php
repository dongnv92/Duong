                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <div class="p-1"><img src="assets/images/logo/logo-80x80.png" alt="branding logo"></div>
                                </div>
                                    ...
                                    <form class="form-horizontal form-simple" method="post" action="">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 col-12 text-center text-sm-left">
                                                <fieldset>
                                                    <input type="checkbox" id="remember" name="remember" value="1" class="chk-remember">
                                                    <label for="remember"> Ghi nhớ đăng nhập</label>
                                                </fieldset>
                                            </div>
                                            <div class="col-sm-6 col-12 text-center text-sm-right"><a href="#" class="card-link">Quên mật khẩu</a></div>
                                        </div>
                                        <input type="submit" class="btn btn-info btn-block" id="login" name="submit" value="Đăng nhập">
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script src="assets/vendors/js/extensions/sweetalert.min.js"></script>
<script src="custom.js?act=authencation"></script>
<!-- END: Page JS-->
